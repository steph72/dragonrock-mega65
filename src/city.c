...
byte sharesMenu() {
    ...
    do {
        currentBase= COLOR_RAM + (y * 40) + x + (currentIdx*3);
    ...
    void setupCityScreen(void) {
        ...
        cg_block(28, 7, 39, 24, 160, COLOR_GRAY1);
        cg_block(28, 18, 39, 24, 160, COLOR_BROWN);
    }
    ...
    void distributeSpoils(void) {
        ...
        cg_center(29, 20, 11, "distribute");
        cg_center(29, 21, 11, " gold and ");
        cg_center(29, 22, 11, "experience");
        gotoxy(29, 10);
        sharesMenu();
        cgetc();
